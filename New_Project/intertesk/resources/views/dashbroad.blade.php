        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="ai-icon" href="{{route('category.store')}}" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Category</span>
						</a>
                    </li>
                    <li><a class="ai-icon" href="{{route('sub.category')}}" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">SubCategory</span>
						</a>
                    </li>
                    <li><a class="ai-icon" href="{{route('product.page')}}" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Product</span>
						</a>
                    </li>
                    <li><a class="ai-icon" href="{{route('role')}}" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
