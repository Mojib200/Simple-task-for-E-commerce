                        ...
                        <div class="killore--block-link-content">
                            <ul>
                                @foreach ($categorys as $category)
                                    <li> 
                                        <a 
                                        {{-- href="{{route('category_product',$category->id)}}" --}}
                                            >
                                        <img
                                                src="{{ asset('categoryimage') }}/{{ $category->category_image }}"
                        ...
                        <div class="product_grid card b-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    {{-- <a class="card-img-top d-block overflow-hidden" href="{{route('product_detiles',$product->product_slug)}}"> --}}
                                    <a class="card-img-top d-block overflow-hidden" >
                                        <img
                                            src="{{ asset('product') }}/{{ $product->preview }}"
                                ...
                                <div class="text-left">
                                    <div class="text-left">
                                        ...
                                        <h5 class="fs-md mb-0 lh-1 mb-1"><a>
                                                {{-- href="{{route('product_detiles',$product->product_slug)}}">{{ $product->product_name }} --}}
                                            </a>
                                        </h5>
                        ...
                        <div class="cats_side_wrap text-center mx-auto mb-3">
                            <div class="sl_cat_01">
                                <div
                                    ...
                                    <a>
                                         {{-- href="{{route('category_product',$category->id)}}" class="d-block"> --}}
                                         <img
                                            src="{{ asset('categoryimage') }}/{{ $category->category_image }}"
                        ...
                        @foreach ($featured_products as $featured_product)
                            <div class="product_grid row">
                                <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                                    <div class="shop_thumb position-relative">
                                        <a class="card-img-top d-block overflow-hidden"
                                         {{-- href="{{route('product_detiles',$featured_product->product_slug)}}" --}}
                                         ><img
                                                src="{{ asset('product') }}/{{ $featured_product->preview }}"
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                                    <div class="text-left mfliud">
                                        ...
                                        <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium"><a
                                            {{-- href="{{route('product_detiles',$featured_product->product_slug)}}" --}}
                                            >{{ $featured_product->product_name }}</a></h5>
                                        <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                            <i class="fas fa-star filled"></i>
                                            <i class="fas fa-star filled"></i>
                                            <i class="fas fa-star filled"></i>
